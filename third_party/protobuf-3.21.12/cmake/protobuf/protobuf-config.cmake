...
function(protobuf_generate)
  ...
  if(NOT protobuf_generate_PROTOS AND NOT protobuf_generate_TARGET)
    ...
    message("protobuf_generate_PROTOS: ${protobuf_generate_PROTOS}")
  endif()
  ...
  foreach(_proto ${protobuf_generate_PROTOS})
    ...
    execute_process(
        COMMAND ${Protobuf_PROTOC_EXECUTABLE}
                --${protobuf_generate_LANGUAGE}_out=${protobuf_generate_PROTOC_OUT_DIR}
    ...
    message(STATUS "Result=${result_variable}")
    message(STATUS "Output=${output_variable}")
    message(STATUS "Error=${error_variable}")
    if(NOT ${result_variable} EQUAL 0)
        message(FATAL_ERROR "Failed to generate code ${ABS_FIL}")
    endif()
  endforeach()
